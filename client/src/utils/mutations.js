...
export const ADD_BIRD_POST = gql`
  mutation addBirdPost($birdName: String!, $birdId: ID!, $birdImage: String!,$birdAuthor: String!){
    addBirdPost(birdName: $birdName,birdId:$birdId,birdImage: $birdImage, birdAuthor: $birdAuthor) {
      birdName
      birdId
      birdImage
      birdAuthor
